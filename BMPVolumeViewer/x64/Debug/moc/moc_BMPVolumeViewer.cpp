...
QT_MOC_LITERAL(8, 154, 28), // "on_xSliceSlider_valueChanged"
QT_MOC_LITERAL(9, 183, 28) // "on_ySliceSlider_valueChanged"
    ...
    "on_xSliceSlider_valueChanged\0"
    "on_ySliceSlider_valueChanged"
};
...
void BMPVolumeViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->on_xSliceSlider_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 6: _t->on_ySliceSlider_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
